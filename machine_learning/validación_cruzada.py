...
def ejecutar_validación_cruzada(
  ...
  for año in años_entrenamiento:                                                          # Para todos los años de los años de Fruchtman:
    ...
    pred, _, j_v           = knn.predecir_ventana(data_MAG)                               # Obtengo sólo etiquetas y j con predecir_ventana.
    j_BS_pred: np.ndarray       = j_v[pred == 1]                                          # Obtengo solo los índices de BS.
